...
export default class ChatList extends Component {
  ...
  toggleDrawer = () => {
    ...
    componentDidMount() {
      console.info('Go to observeRecentContact in Chatlist');
      ...
      /*
         this.sessionListener =   NativeAppEventEmitter.addListener("observeRecentContact",  (data)=>{
            ...
            console.info('会话列表fromObserve',data);
        });
        */
      NimSession.getRecentContactList().then( (data) => {
        ...
        console.info('会话列表fromNimSesson.getRecent...',data);
        }
      ).catch( (err) => {
        console.info('会话列表错误fromNimSesson.getRecent...',data);
        }
      )
    }
