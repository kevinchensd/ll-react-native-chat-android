...
class Chat extends React.Component {
    ...
    componentWillMount() {
	console.log('Chat.ios Entered Chat.ios. will mount....');
        const {session} = this.props;
	console.log('Chat.ios: session is :' + JSON.stringify(session));
